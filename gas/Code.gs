...
var PROGRAMAS = {
  ...
  'procesamiento-agroindustrial': { area: 'agro' },
  ...
  'programacion-web': { area: 'tecnologia' },
  'programacion-dispositivos-moviles': { area: 'tecnologia' },
  'programacion-videojuegos': { area: 'tecnologia' },
  ...
  'redes-electricas': { area: 'industria' },
  ...
  'expresion-artistica-escena': { area: 'arte-cultura' },
};
